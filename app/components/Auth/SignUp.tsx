...
const SignUp: FC<Props> = ({ setRoute }) => {
  ...
  useEffect(() => {
    // console.log("In useEffect of SignUp");
    if (isSuccess) {
  ...
  return (
    <div className="w-full">
      <h1 className={`${styles.title}`}>Join to WeLearn</h1>
      <form onSubmit={handleSubmit}>
        ...
        <h3 className="text-center pt-4 font-Poppins text-[14px] text-black dark:text-white">
          <span
            className="text-[#2190ff] pl-1 cursor-pointer"
